...
- **rx4** crate — path dep to local rotary during development (`rx4 = { path = "../../../rotary", version = "0.3.9", features = [providers, builtin-tools, computer-use, skills, graph-memory, mcp, ipc] }`); bump crates.io when published
